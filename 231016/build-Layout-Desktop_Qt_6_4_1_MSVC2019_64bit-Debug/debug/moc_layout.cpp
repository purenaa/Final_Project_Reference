...
Q_CONSTINIT const QMetaObject Layout::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsLayoutItem::staticMetaObject>(),
...
void *Layout::qt_metacast(const char *_clname)
{
    ...
    return QGraphicsLayoutItem::qt_metacast(_clname);
}

int Layout::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QGraphicsLayoutItem::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
